...
<body>
    ...
    <article>
        ...
        <div class="articulo">
            <div class="producto">
                <?php
                $query = "SELECT * FROM articulos WHERE id = 23";
                $res = mysqli_query($conexion, $query);
                $info = mysqli_fetch_assoc($res);
                echo "<div class='producto-img'>";
                echo "<a data-fancybox='single' data-src='../../imagenestfg/protector.jpg'>";
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    <div class="relacionados">
                        ...
                        <div class="card" style="width: 15em;">
                            <?php
                            $query = "SELECT * FROM articulos WHERE id = 18";
                            $res = mysqli_query($conexion, $query);
                            $info = mysqli_fetch_array($res);
                            ...
                            echo "Modelo: " . $info['modelo'] . "<br>";
                            echo "Precio: " . $info['precio'] . "€ <br></p>";
                            echo "<a href='mascara.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>
                    </div>
                </div>
