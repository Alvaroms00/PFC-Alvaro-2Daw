...
<body>
    ...
    <article>
        ...
        <div class="articulo">
            <div class="producto">
                <?php
                $query = "SELECT * FROM articulos WHERE id = 6";
                $res = mysqli_query($conexion, $query);
                $info = mysqli_fetch_assoc($res);
                echo "<div class='producto-img'>";
                echo "<a data-fancybox='single' data-src='../../imagenestfg/casco.jpg'>";
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="card" style="width: 15em;">
                            <?php
                            $query = "SELECT * FROM articulos WHERE id = 8";
                            $res = mysqli_query($conexion, $query);
                            ...
                            echo "<a href='chaleco.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>

                        <div class="card" style="width: 15em;">
                            <?php
                            $query = "SELECT * FROM articulos WHERE id = 10";
                            $res = mysqli_query($conexion, $query);
                            $info = mysqli_fetch_array($res);
                            ...
                            echo "Modelo: " . $info['modelo'] . "<br>";
                            echo "Precio: " . $info['precio'] . "€ <br></p>";
                            echo "<a href='gafas.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>

                        <div class="card" style="width: 15em;">
                            <?php
                            $query = "SELECT * FROM articulos WHERE id = 19";
                            $res = mysqli_query($conexion, $query);
                            $info = mysqli_fetch_array($res);
                            ...
                            echo "Modelo: " . $info['modelo'] . "<br>";
                            echo "Precio: " . $info['precio'] . "€ <br></p>";
                            echo "<a href='mascarilla.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>
                        </div>
                    </div>
