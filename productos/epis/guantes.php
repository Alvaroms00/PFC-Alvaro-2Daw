        ...
        <div class="articulo">
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/guantes.jpg">
                        <?php
                        $query = "SELECT tipo, imagen FROM imagenes WHERE id = 11";
                        $res = mysqli_query($conexion, $query);
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                        <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="Guantes">
                    </a>
                </div>
                <!-- Producto -->
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <ul>
                            ...
                            <li>Resisten cortes y son resistentes</li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="relacionados">
                            ...
                            <div class="card" style="width: 15em;">
                                ...
                                $imagen = mysqli_fetch_assoc($res);
                                ?>
                                <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" class="card-img-top" alt="protector">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php
                                    ...
                                    <a href="protector.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>
                            ...
                            <div class="card" style="width: 15em;">
                                ...
                                $imagen = mysqli_fetch_assoc($res);
                                ?>
                                <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" class="card-img-top" alt="zapatillas">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php
