    ...
    <article>
        ...
        <div class="articulo">
            <div class="producto">
                ...
                echo "<a data-fancybox='single' data-src='../../imagenestfg/mascarilla.jpg'>";
            ...
            <div class="descripcion" id="descripcion">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <ul>
                            <li>Mascarilla FFP2</li>
                            <li>Protege frente al polvo y particulas pequeñas</li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="card" style="width: 15em;">
                            <?php
                            $query = "SELECT * FROM articulos WHERE id = 32";
                            $res = mysqli_query($conexion, $query);
                            $info = mysqli_fetch_array($res);
                            ...
                            echo "Modelo: " . $info['modelo'] . "<br>";
                            echo "Precio: " . $info['precio'] . "€ <br></p>";
                            echo "<a href='zapatillas.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>
                        </div>
                    </div>
