    ...
    <article>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Gafas</li>
            </ol>
        </nav>
        <!-- Pricipio aside -->
        <aside>
        ...
        <div class="articulo">
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/gafas.jpg">
                        <?php
                        $query = "SELECT tipo, imagen FROM imagenes WHERE id = 10";
                        $res = mysqli_query($conexion, $query);
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                        <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="gafas">
                    </a>
                </div>
                <!-- Producto -->
            ...
            <div class="descripcion" id="descripcion">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <ul>
                            <li>Gafas de protección transparente</li>
                            <li>Proteccion frente al polvo y materiales pequeños</li>
                        </ul>
                    </div>
                        ...
                        <div class="relacionados">
                            ...
                            <div class="card" style="width: 15em;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="guantes.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>
