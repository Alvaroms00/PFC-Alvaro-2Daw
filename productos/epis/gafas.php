    ...
    <article>
        ...
        <div class="articulo">
            <div class="producto">
                ...
                echo "<a data-fancybox='single' data-src='../../imagenestfg/gafas.jpg'>";
            ...
            <div class="descripcion" id="descripcion">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="card" style="width: 15em;">
                            <?php
                            $query = "SELECT * FROM articulos WHERE id = 11";
                            $res = mysqli_query($conexion, $query);
                            $info = mysqli_fetch_array($res);
                            ...
                            echo "Modelo: " . $info['modelo'] . "<br>";
                            echo "Precio: " . $info['precio'] . "€ <br></p>";
                            echo "<a href='guantes.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>
