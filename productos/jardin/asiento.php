  ...
  <article>
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../../html/jardin.php">Jardín</a></li>
    ...
    <aside>
      <div class="flex-shrink-0 bg-white" style="width: 280px;">
        ...
        <ul class="list-unstyled ps-0">
          ...
          <li class="mb-1">
            <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#customers-collapse" aria-expanded="true">
              Jardín
            </button>
            <div class="collapse show" id="customers-collapse">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li><a href="asiento.php" class="link-dark rounded">Asiento</a></li>
                <li><a href="banco.php" class="link-dark rounded">Banco</a></li>
                <li><a href="cenador.php" class="link-dark rounded">Cenador</a></li>
                <li><a href="mesa-plegable.php" class="link-dark rounded">Mesa Plegable</a></li>
              </ul>
            </div>
          </li>
        </ul>
      ...
      <div class="producto">
        <div class="producto-img">
          <a data-fancybox="single" data-src="../../imagenestfg/asientos.jpg">
            ...
            ?>
            <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="asientos">
          </a>
        </div>
        <!-- Producto -->
          ...
          <div class="relacionados">
            <div class="card" style="width: 15em;">
              ...
              <div class="card-body">
                ...
                <a href="banco.php" class="btn btn-dark">Ver Producto</a>
              </div>
            </div>
            ...
            <div class="card" style="width: 15em;">
              ...
              <div class="card-body">
                ...
                <a href="cenador.php" class="btn btn-dark">Ver Producto</a>
              </div>
            </div>
            ...
            <div class="card" style="width: 15em;">
              ...
              <div class="card-body">
                ...
                <a href="mesa-plegable.php" class="btn btn-dark">Ver Producto</a>
              </div>
            </div>
          </div>
        </div>
