          ...
          <li class="mb-1">
            ...
            <div class="collapse" id="orders-collapse">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <li><a href="../electricas/martilloligero.php" class="link-dark rounded">Martillo Ligero</a>
                </li>
                ...
                <li><a href="../electricas/taladrocomb.php" class="link-dark rounded">Taladro Combinado</a>
                </li>
            ...
            <div class="relacionados">
              <div class="card" style="width: 15em;">
                ...
                <div class="card-body">
                  ...
                  <a href="asiento.php" class="btn btn-dark">Ver Producto</a>
                </div>
              </div>
