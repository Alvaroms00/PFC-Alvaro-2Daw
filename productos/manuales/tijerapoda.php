    ...
    <article>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tijera de Podar</li>
            </ol>
        </nav>
        <!-- Pricipio aside -->
        <aside>
        ...
        <div class="articulo">
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/tijerapoda.jpg">
                        <?php
                        $query = "SELECT tipo, imagen FROM imagenes WHERE id = 31";
                        $res = mysqli_query($conexion, $query);
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                ...
                <div class="producto-info">
                    <div class="titulo">
                        <h1>
                            <?php
                            $query = "SELECT nombre, caracteristica, marca, modelo, precio FROM articulos WHERE id = 31";
                            $res = mysqli_query($conexion, $query);
            ...
            <div class="descripcion" id="descripcion">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <ul>
                            <li>Hoja pulida para profesionales que garantiza el más alto rendimiento.</li>
                            <li>Cabezal de corte estrecho para llegar a cualquier parte de forma fácil y rápida, con cortes precisos.</li>
                            <li>Mangos de aluminio ligeros con hojas y contrahojas ensambladas en los mismos para facilitar el mantenimiento.</li>
                            <li>Amortiguadores de impactos de goma que reducen el cansancio y aumentan la comodidad.</li>
                            <li>Tijeras de podar ligeras diseñadas para cortar madera blanda o verde, especialmente en viñedos y huertos.</li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="info-tecnica">
                            ...
                            <a href="../ficha tecnica/manuales/tijerapoda.pdf" target="_blank"><i class="far fa-file-pdf"></i>
                                &nbsp; Información del Producto</a> <br>
                            <a href="../ficha tecnica/manuales/tijerapoda.pdf" download=""><i class="fas fa-file-download"></i>
                                &nbsp; Descargar</a>
                        </div>
                    </div>
                        ...
                        <div class="relacionados">
                            <div class="card" style="width: 15em;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="azada.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>

                            <div class="card" style="width: 15em;">
                                <?php
                                $query = "SELECT tipo, imagen FROM imagenes WHERE id = 16";
                                $res = mysqli_query($conexion, $query);
                                $imagen = mysqli_fetch_assoc($res);
                                ?>
                                <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" class="card-img-top" alt="martillo">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php
                                        $query = "SELECT nombre, caracteristica, marca, modelo, precio FROM articulos WHERE id = 16";
                                        $res = mysqli_query($conexion, $query);
                                        $info = mysqli_fetch_array($res);
                                        echo $info['nombre'];
                                        ?>
                                    ...
                                    <a href="martillo.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>

                            <div class="card" style="width: 15em;">
                                <?php
                                $query = "SELECT tipo, imagen FROM imagenes WHERE id = 22";
                                $res = mysqli_query($conexion, $query);
                                $imagen = mysqli_fetch_assoc($res);
                                ?>
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php
                                        $query = "SELECT nombre, caracteristica, marca, modelo, precio FROM articulos WHERE id = 22";
                                        $res = mysqli_query($conexion, $query);
                                        $info = mysqli_fetch_array($res);
                                        echo $info['nombre'];
                                        ?>
