    ...
    <article>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Azada</li>
            </ol>
        </nav>
        <!-- Pricipio aside -->
        <aside>
        ...
        <div class="articulo">
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/azada.jpg">
                        <?php
                        $query = "SELECT tipo, imagen FROM imagenes WHERE id = 4";
                        $res = mysqli_query($conexion, $query);
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                        <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="Azada">
                    </a>
                </div>
                <!-- Producto -->
            ...
            <div class="descripcion" id="descripcion">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <ul>
                            <li>Azada forjada en una sola pieza en acero al boro, pulida y afilada</li>
                            <li>No se desgasta y podras usarla toda la vida</li>
                            <li>Trabajarás la tierra sin miedo a que la azada se deforme. La introducirás mejor y ahorrarás tiempo y esfuerzo.</li>
                            <li>Perfecta para su uso en el campo o en el jardín</li>
                        </ul>
                    </div>
                        ...
                        <div class="relacionados">
                            ...
                            <div class="card" style="width: 15em;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="horca.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>
