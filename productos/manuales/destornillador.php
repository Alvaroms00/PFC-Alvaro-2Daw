    ...
    <article>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Destornillador</li>
            </ol>
        </nav>
        <!-- Pricipio aside -->
        <aside>
        ...
        <div class="articulo">
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/destornillador.jpg">
                        <?php
                        $query = "SELECT tipo, imagen FROM imagenes WHERE id = 9";
                        $res = mysqli_query($conexion, $query);
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                        <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="destornillador">
                    </a>
                </div>
                <!-- Producto -->
                        ...
                        <div class="relacionados">
                            ...
                            <div class="card" style="width: 15em;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="tijerapoda.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>
                        </div>
                    </div>
