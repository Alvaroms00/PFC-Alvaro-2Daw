            ...
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/martilloligero.jpg">
                        <?php
                        $query = "SELECT tipo, imagen FROM imagenes WHERE id = 17";
                        $res = mysqli_query($conexion, $query);
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                        <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="martillo ligero">
                    </a>
                </div>
                <!-- Producto -->
                <div class="producto-info">
                    <div class="titulo">
                        <h1>
                            <?php
                            $query = "SELECT nombre, caracteristica, marca, modelo, precio FROM articulos WHERE id = 17";
                            $res = mysqli_query($conexion, $query);
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="info-tecnica">
                            ...
                            <a href="../ficha tecnica/electricas/martilloligero.pdf" download="martilloligero"><i class="fas fa-file-download"></i> &nbsp; Descargar</a>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="relacionados">
                            ...
                            <div class="card" style="width: 15em;">
                                ...
                                $imagen = mysqli_fetch_assoc($res);
                                ?>
                                <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" class="card-img-top" alt="atornillador">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php
                                    ...
                                    <a href="atornillador.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>
