...
<body>
    ...
    <article>
        ...
        <div class="articulo">
            <div class="producto">
                <?php
                $query = "SELECT * FROM articulos WHERE id = 26";
                $res = mysqli_query($conexion, $query);
                $info = mysqli_fetch_assoc($res);
                echo "<div class='producto-img'>";
                echo "<a data-fancybox='single' data-src='../../imagenestfg/taladroperc.jpg'>";
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="info-tecnica">
                        ...
                        <a href="../ficha tecnica/electricas/taladroperc.pdf" download="taladroperc"><i class="fas fa-file-download"></i> &nbsp; Descargar</a>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    <div class="relacionados">
                        <div class="card" style="width: 15em;">
                            ...
                            echo "<a href='amoladora.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>
