            ...
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/atornillador.jpg">
                        ...
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                        <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="atornillador">
                    </a>
                </div>
                <!-- Producto -->
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="info-tecnica">
                            ...
                            <a href="../ficha tecnica/electricas/atornillador.pdf" download="atornillador"><i class="fas fa-file-download"></i> &nbsp; Descargar</a>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="relacionados">
                            ...
                            <div class="card" style="width: 15em;">
                                ...
                                $imagen = mysqli_fetch_assoc($res);
                                ?>
                                <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" class="card-img-top" alt="martillo ligero">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php
                                    ...
                                    <a href="martilloligero.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>
