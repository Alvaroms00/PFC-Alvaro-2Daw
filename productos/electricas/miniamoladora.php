    ...
    <article>
        ...
        <div class="articulo">
            <div class="producto">
                ...
                echo "<a data-fancybox='single' data-src='../../imagenestfg/miniamoladora.jpg'>";
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    <div class="relacionados">
                        ...
                        <div class="card" style="width: 15em;">
                            ...
                            echo "Modelo: " . $info['modelo'] . "<br>";
                            echo "Precio: " . $info['precio'] . "€ <br></p>";
                            echo "<a href='lijadora.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>
                        ...
                        <div class="card" style="width: 15em;">
                            ...
                            echo "Modelo: " . $info['modelo'] . "<br>";
                            echo "Precio: " . $info['precio'] . "€ <br></p>";
                            echo "<a href='sierra.php' class='btn btn-dark'>Ver Producto</a> </div>";
                            ?>
                        </div>
                    </div>
                </div>
