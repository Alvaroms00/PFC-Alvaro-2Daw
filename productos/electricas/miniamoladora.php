    ...
    <article>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="../../html/electricas.php">Herramientas Eléctricas</a></li>
                ...
                <ul class="list-unstyled ps-0">
                    ...
                    <li class="mb-1">
                        ...
                        <div class="collapse show" id="orders-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="amoladora.php" class="link-dark rounded">Amoladora</a></li>
                                <li><a href="atornillador.php" class="link-dark rounded">Atornillador</a></li>
                                <li><a href="lijadora.php" class="link-dark rounded">Lijadora</a></li>
                                <li><a href="martilloligero.php" class="link-dark rounded">Martillo Ligero</a></li>
                                <li><a href="miniamoladora.php" class="link-dark rounded">Mini Amoladora</a></li>
                                <li><a href="sierra.php" class="link-dark rounded">Sierra de Calar</a></li>
                                <li><a href="taladrocomb.php" class="link-dark rounded">Taladro Combinado</a></li>
                                <li><a href="taladroperc.php" class="link-dark rounded">Taladro Percutor</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="mb-1">
        ...
        <div class="articulo">
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/miniamoladora.jpg">
                        <?php
                        $query = "SELECT tipo, imagen FROM imagenes WHERE id = 21";
                        $res = mysqli_query($conexion, $query);
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                        <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="mini amoladora">
                    </a>
                </div>
                <!-- Producto -->
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="info-tecnica">
                            ...
                            <a href="../ficha tecnica/electricas/miniamoladora.pdf" download="miniamoladora"><i class="fas fa-file-download"></i> &nbsp; Descargar</a>
                        </div>
                    </div>
                        ...
                        <div class="relacionados">
                            <div class="card" style="width: 15em;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="amoladora.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>

                            <div class="card" style="width: 15em;">
                                <?php
                                $query = "SELECT tipo, imagen FROM imagenes WHERE id = 14";
                                $res = mysqli_query($conexion, $query);
                                $imagen = mysqli_fetch_assoc($res);
                                ?>
                                <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" class="card-img-top" alt="lijadora">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php
                                        $query = "SELECT nombre, caracteristica, marca, modelo, precio FROM articulos WHERE id = 14";
                                        $res = mysqli_query($conexion, $query);
                                        $info = mysqli_fetch_array($res);
                                        echo $info['nombre'];
                                        ?>
                                    ...
                                    <a href="lijadora.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>
                            ...
                            <div class="card" style="width: 15em;">
                                ...
                                $imagen = mysqli_fetch_assoc($res);
                                ?>
                                <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" class="card-img-top" alt="sierra">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php
                                    ...
                                    <a href="sierra.php" class="btn btn-dark">Ver Producto</a>
                                </div>
                            </div>
                        </div>
                    </div>
