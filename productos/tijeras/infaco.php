    ...
    <article>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tijera Infaco</li>
            </ol>
        </nav>
        <!-- Pricipio aside -->
        <aside>
        ...
        <div class="articulo">
            <div class="producto">
                <div class="producto-img">
                    <a data-fancybox="single" data-src="../../imagenestfg/tijerainfaco.jpg">
                        <?php
                        $query = "SELECT tipo, imagen FROM imagenes WHERE id = 29";
                        $res = mysqli_query($conexion, $query);
                        $imagen = mysqli_fetch_assoc($res);
                        ?>
                        <img src="data:<?php echo $imagen['tipo']; ?>;base64,<?php echo base64_encode($imagen['imagen']); ?>" alt="Tijera Infaco">
                    </a>
                </div>
                <!-- Producto -->
            ...
            <div class="descripcion" id="descripcion">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <ul>
                            <li>Podadora más ligera, compacta y rápida</li>
                            <li>Cuchilla cremallera de un solo bloque</li>
                            <li>Gatillo progresivo para un mejor corte</li>
                            <li>Indicador led de vida de la bateria</li>
                            <li>Baterias de litio recargables</li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="info-tecnica">
                            ...
                            <a href="../ficha tecnica/tijeras/infaco.pdf" target="_blank"><i class="far fa-file-pdf"></i>
                                &nbsp; Información del Producto</a> <br>
                            <a href="../ficha tecnica/tijeras/infaco.pdf" download=""><i class="fas fa-file-download"></i> &nbsp; Descargar</a>
                        </div>
                    </div>
